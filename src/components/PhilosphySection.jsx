      ...
      <ul className="principles-list">
        <li className="principles-item">
          ...
          <p className="principles-item-description">
            Para nosotros, la salud y el bienestar de nuestros clientes son lo
            primero. Fomentamos el desarrollo de buenos hábitos que lleven a un
            estilo de vida más saludable.
          </p>
        </li>
        <li className="principles-item">
          <h3 className="principles-item-title">Buscamos la Excelencia</h3>
          <p className="principles-item-description">
            Creemos en ofrecer un servicio de alta calidad a nuestros clientes.
            Siempre estamos esforzándonos por la excelencia en nuestras
            planificaciones.
          </p>
        </li>
        <li className="principles-item">
          ...
          <p className="principles-item-description">
            ...
            prevenir lesiones y asegurarnos de que nuestros clientes obtengan el
            máximo beneficio de sus entrenamientos.
          </p>
        </li>
        <li className="principles-item">
        ...
        <li className="principles-item">
          <h3 className="principles-item-title">Empatía y comprensión</h3>
          <p className="principles-item-description">
            Entendemos que cada uno de nuestros atletas tiene necesidades y
            objetivos únicos. Tomamos el tiempo para escucharlos y comprender
            sus necesidades, objetivos y aspiraciones.
          </p>
        </li>
        <li className="principles-item">
